...
- [add serial number in attendance sheet report | remove shift type from fixtures, import shift type using patches](https://gitlab.com/atri-tech/atri-maintainers/ethal/-/merge_requests/277)
