...
def execute(filters=None):
	...
	mpc = [b / m if m != 0 and b!=0 else 0 for b,m in zip(res_data_61000_total, res_data_41100_total)]
	mpc = absolute_value(mpc)	

	fc = [b / m if m != 0 and b!=0 else 0 for b,m in zip(res_data_62000_total, res_data_41100_total)]
	fc = absolute_value(fc)

	general_and_admin_expenses = [b / m if m != 0 and b!=0 else 0 for b,m in zip(res_data_63000_total, res_data_41100_total)]
	general_and_admin_expenses = absolute_value(general_and_admin_expenses)

	non_operational_ho = [b / m if m != 0 and b!=0 else 0 for b,m in zip(res_data_64000_total, res_data_41100_total)] 	
