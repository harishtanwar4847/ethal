...
def execute(filters=None):
	...
	res_data_41100 = get_result_with_filters('41100 - Aluminum Utensil Sales - E21', filters, account_details)
	
	direct_material = [(a+b+c+d)/e if e !=0 for a,b,c,d,e in zip(res_data_51000_01, res_data_51000_02, res_data_52000_01, res_data_53000_01,res_data_41100)]
	direct_material = aboslute_value(direct_material)
	print(db_sales)
	fuel = [(a/b) if b !=0 for a,b in zip(res_data_51000_03, res_data_41100)]
	fuel = aboslute_value(fuel)
	manpower_cost = [(a+b+c+d)/e if e !=0 for a,b,c,d,e in zip(res_data_51000_04, res_data_52000_02, res_data_53000_02,res_data_54100, res_data_41100)]
	manpower_cost = aboslute_value(manpower_cost)
	stores_and_repairs = [(a+b)/c if c!=0 for a,b,c in zip(res_data_54200, res_data_54300, res_data_41100)]
	stores_and_repairs = aboslute_value(stores_and_repairs)
	utilities = [(c+d)/e if e !=0 for a,b,c,d,e in zip(res_data_52000_04, res_data_53000_04,res_data_41100)]
