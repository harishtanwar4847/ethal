...
def get_data():
	...
	def manpower_cost():
		...
		lst_52000_02 = get_monthly_gl_debit_no_opening("52000-02%")
		lst_53000_02 = get_monthly_gl_debit_no_opening("53000-02%")
		lst_54100 = get_monthly_gl_debit_no_opening("54100%")
		sales_invoice = sales_invoice_qty()
	...
	def stores_repair_cost():
		lst_54200 = get_monthly_gl_debit_no_opening("54200%")
		lst_54300 = get_monthly_gl_debit_no_opening("54300%")
		sales_invoice = sales_invoice_qty()
		final_res = [((a+b)/c[0]) if c[0]!=0 else 0 for a,b,c in zip(lst_54200, lst_54300, sales_invoice)]
		return final_res

	def utilities_cost():
		lst_54400 = get_monthly_gl_debit_no_opening("54400%")
		lst_51000_05 = get_monthly_gl_debit_no_opening("51000_05%")
		lst_52000_04 = get_monthly_gl_debit_no_opening("52000_04%")
		lst_53000_04 = get_monthly_gl_debit_no_opening("53000_04%")
		sales_invoice = sales_invoice_qty()
	...
	direct = direct_material()
	fuel = fuel_mt_sold()
	manpower = manpower_cost()
	stores = stores_repair_cost()
