...
def execute(filters=None):
	...
	# +["Fuel/Total sales ::180"]+["Manpower Cost - Factory/Total sales ::180"]+["Stores & Repairs/Total sales ::180"]+["Utilities - Electricity & Water/Total sales ::180"]
	data = get_data()
	return columns, data
...
def get_data():
	...
	def direct_material():
		...
		lst_50000 = get_monthly_gl_credit_no_opening("5%")
